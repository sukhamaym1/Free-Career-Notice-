...
// Replace share buttons
const targetShareWidget = `              <div className="flex gap-2 mb-3">
...
const replacementShareWidget = `              <div className="flex gap-2 mb-3">
...
content = content.replace(targetShareWidget, replacementShareWidget);

fs.writeFileSync('src/pages/PostPage.tsx', content);
console.log('Patched PostPage.tsx successfully.');
