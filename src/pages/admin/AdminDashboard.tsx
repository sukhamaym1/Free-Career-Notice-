        ...
        <div className="bg-white dark:bg-[#1e293b] rounded-xl border border-slate-200 dark:border-slate-700/50 shadow-sm p-6 animate-in fade-in duration-300">
          ...
          <form onSubmit={handleCreate} className="space-y-4 max-w-2xl">
            ...
            <div className="pt-4 flex gap-4">
              ...
              <button type="button" onClick={() => setActiveTab('Dashboard')} className="px-6 py-2 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-800 dark:text-white rounded-lg font-medium transition-colors">
                Cancel
              </button>
            </div>
          </form>
